...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	b, err := h.svc.Create(r.Context(), req.Name, req.PlantNo, req.Site, req.ResponsiblePerson, req.SapNo, req.ResponsiblePersonTel)
	if err != nil {
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	b, err := h.svc.Update(r.Context(), id, req.Name, req.PlantNo, req.Site, req.ResponsiblePerson, req.SapNo, req.ResponsiblePersonTel)
	if err != nil {
